...
function getIngredientRow() {
    ...
    let body = `
        <td>
                <input id="ingredientNameInput" placeholder="Inserisci l'ingrediente" class="form-control" type="text">
            </td>
            <td>
                <input id="quantityInput" placeholder="Inserisci la quantità" class="form-control" type="number" min="1" max="10000">
            </td>
            <td>
                <select id="unitInput" class="form-select">
                    {{quantity_types}}
                </select>
            </td>
            <td>
...
function getMealTable(day_number, meal_number, ingredient_rows) {
    ...
    let body = `
        <tr>
            <td colspan="3">
                <div style="display: flex; justify-content: center">
                    <input id="mealNameInput" placeholder="Inserisci il pasto" class="form-control" type="text">
                </div>
            </td>
            <td>
                <div style="display: flex; justify-content: center">
...
function saveMealPlan() {
    ...
    xhr.send(JSON.stringify(mealPlan));
    xhr.onload = function () {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    //let day_number = document.getElementById("mealPlanContent").childElementCount + 1;
    //let ingredient_row = [getIngredientRow(exercises)];
    //let day_template = getWorkoutDayTemplate(day_number, ingredient_row);
    //let day = document.createElement("div");
    //day.innerHTML = day_template;
    //document.getElementById("mealPlanContent").appendChild(day);
